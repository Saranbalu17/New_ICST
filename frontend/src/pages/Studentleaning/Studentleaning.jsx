            ...
            <div className="flex overflow-x-auto  space-x-1 bg-gray-100 p-1.5 rounded-lg w-full sm:w-auto shadow-sm">
              <button
                className={`px-5 py-2.5 text-sm font-semibold rounded-md transition-all duration-200 whitespace-nowrap ${
                  selectedTab === 'all' ? 'bg-white shadow-md text-indigo-600' : 'text-gray-600 hover:bg-gray-200'
                }`}
              ...
              <button
                className={`px-5 py-2.5 text-sm font-semibold rounded-md transition-all duration-200 whitespace-nowrap ${
                  selectedTab === 'in-progress' ? 'bg-white shadow-md text-indigo-600' : 'text-gray-600 hover:bg-gray-200'
                }`}
              ...
              <button
                className={`px-5 py-2.5 text-sm font-semibold rounded-md transition-all duration-200 whitespace-nowrap ${
                  selectedTab === 'not-started' ? 'bg-white shadow-md text-indigo-600' : 'text-gray-600 hover:bg-gray-200'
                }`}
              ...
              <button
                className={`px-5 py-2.5 text-sm font-semibold rounded-md transition-all duration-200 whitespace-nowrap ${
                  selectedTab === 'completed' ? 'bg-white shadow-md text-indigo-600' : 'text-gray-600 hover:bg-gray-200'
                }`}
