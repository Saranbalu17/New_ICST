  ...
  const sendMarksToEmail = async (email, marks, percentage) => {
    try {
      const response = await fetch(
        `${baseUrl}/LMS/SendFeedbackScoreEmail`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 sm:p-5 md:p-6 transition-all duration-300 hover:shadow-md font-quicksand bg-gray-50">
      <div className="bg-white/90 rounded-xl shadow-md backdrop-blur-sm p-6 sm:p-8 md:p-10 mx-auto my-8 sm:my-10 md:my-12 max-w-3xl animate-floatUp">
        <h1 className="text-center font-bold text-2xl sm:text-3xl md:text-4xl bg-gradient-to-r from-teal-400 to-cyan-500 text-transparent bg-clip-text">
          GPMS TRANSPORTAL AI
        </h1>
        ...
        >
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center">
                  <div className="flex flex-col items-center my-4 sm:my-5 max-w-[250px] sm:max-w-[280px] md:max-w-[300px]">
                    <div
                      ...
                      style={{
                        backgroundImage: 'linear-gradient(to right, #ef4444, #facc15, #22c55e)',
                        backgroundColor: '#ffffff',
                      }}
                    >
                      <div
                        className="absolute bottom-0 left-[5%] w-[90%] h-[90%] bg-white rounded-t-full border-2 border-gray-800"
                        style={{ backgroundColor: '#ffffff', borderColor: '#1F2937' }}
                      ></div>
                      <div
                      ...
                      <div className="absolute w-full h-full flex justify-between items-end p-2 sm:p-2.5">
                        {[...Array(Math.ceil(maxMarks / 10))].map((_, i) => {
                          const mark = i * 10;
                          const angle = maxMarks ? (mark / maxMarks) * 180 - 90 : -90;
                          return (
                            <span
                              key={mark}
                              ...
                              style={{
                                ...
                                fontWeight: mark === obtainedMarks ? 'bold' : 'normal',
                                backgroundColor: mark === obtainedMarks ? 'rgba(255, 255, 0, 0.3)' : 'transparent',
                                color: '#4B5563',
                              }}
                            >
                              {mark}
                        ...
                        {maxMarks > 0 && (
                          <span
                            ...
                            style={{
                              ...
                              fontWeight: maxMarks === obtainedMarks ? 'bold' : 'normal',
                              backgroundColor: maxMarks === obtainedMarks ? 'rgba(255, 255, 0, 0.3)' : 'transparent',
                              color: '#4B5563',
                            }}
                          >
                            {maxMarks}
                    ...
                    <div className="mt-3 text-center text-gray-700 text-sm md:text-base" style={{ color: '#4B5563' }}>
                      <p>
                        <strong>Score:</strong> {obtainedMarks}/{maxMarks}
                      </p>
                      <p>
                        <strong>Percentage:</strong> {preAssessmentResult.preAssessmentList[0].percentage || 0}%
                      </p>
                    </div>
                  </div>
                </div>
                <div className="mt-4">
                  ...
                  >
                    ...
                    <span className="text-red-600 ml-1" style={{ color: '#DC2626' }}>*</span>
                  </label>
                  <input
                    type="email"
          ...
          {submissionStatus === "alreadySaved" && (
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm md:text-base" style={{ color: '#6B7280' }}>
